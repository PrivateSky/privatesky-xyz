...
const PskLiveCode = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.value = '';
        this.language = 'markup';
        this._updateViewModel = (evt) => {
    ...
    render() {
        return (h("div", { class: "live-editor-container" }, h("textarea", { value: this.value, class: `prism-live language-${this.language}`, onKeyUp: this._updateViewModel, onChange: this._updateViewModel })));
    }
...
__decorate([
    CustomTheme(),
    BindModel()
], PskLiveCode.prototype, "modelHandler", void 0);
__decorate([
...
], PskLiveCode.prototype, "value", void 0);
__decorate([
    TableOfContentProperty({
...
], PskLiveCode.prototype, "language", void 0);

export { PskLiveCode as psk_live_code };
