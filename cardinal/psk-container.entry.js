...
import { C as ControllerRegistryService } from './ControllerRegistryService-dce966e3.js';

bindableModelRequire=(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t);}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\builds\\tmp\\bindableModel.js":[function(require,module,exports){
if(typeof window.process === "undefined"){
	window.process = {};
}
require("./bindableModel_intermediar");

},{"./bindableModel_intermediar":"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\builds\\tmp\\bindableModel_intermediar.js"}],"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\builds\\tmp\\bindableModel_intermediar.js":[function(require,module,exports){
(function (global){
...
},{"overwrite-require":"overwrite-require","psk-bindable-model":"psk-bindable-model","queue":"queue","soundpubsub":"soundpubsub"}],"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\modules\\overwrite-require\\moduleConstants.js":[function(require,module,exports){
module.exports = {
...
},{}],"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\modules\\overwrite-require\\standardGlobalSymbols.js":[function(require,module,exports){
(function (global){
let logger = console;
...
},{"psklogger":false}],"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\modules\\psk-bindable-model\\lib\\PskBindableModel.js":[function(require,module,exports){
...
},{"soundpubsub":"soundpubsub"}],"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\modules\\soundpubsub\\lib\\soundPubSub.js":[function(require,module,exports){
/*
...
},{"./moduleConstants":"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\modules\\overwrite-require\\moduleConstants.js","./standardGlobalSymbols.js":"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\modules\\overwrite-require\\standardGlobalSymbols.js"}],"psk-bindable-model":[function(require,module,exports){
module.exports = require("./lib/PskBindableModel");
},{"./lib/PskBindableModel":"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\modules\\psk-bindable-model\\lib\\PskBindableModel.js"}],"queue":[function(require,module,exports){
...
},{"./lib/soundPubSub":"D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\modules\\soundpubsub\\lib\\soundPubSub.js"}]},{},["D:\\work\\git\\webcomponents\\psk-enterprise-workspace\\privatesky\\builds\\tmp\\bindableModel.js"]);
