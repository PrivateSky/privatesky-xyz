            ...
            case 'collapsable':
                {
                    ...
                    result.push(h("div", { class: 'content' }, h("slot", null)), h("div", { class: 'footer', tabindex: 0, onClick: e => this.toggleDetails(e) }, h("psk-icon", { icon: 'chevron-down', class: { 'rotated': this.opened } })));
                    return result;
                }
            case 'plus':
                return [
