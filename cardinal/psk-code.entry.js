...
const PskCode = class {
    ...
    render() {
        ...
        const sourceCode = (h("pre", null, h("code", { class: `language-${this.language}` }, processedCode)));
        if (this.title.replace(/\s/g, '') === '') {
            return sourceCode;
        }
        return h("psk-chapter", { title: this.title }, sourceCode);
    }
...
__decorate([
    CustomTheme(),
    BindModel()
], PskCode.prototype, "modelHandler", void 0);
__decorate([
...
], PskCode.prototype, "title", void 0);
__decorate([
    TableOfContentProperty({
...
], PskCode.prototype, "language", void 0);

export { PskCode as psk_code };
