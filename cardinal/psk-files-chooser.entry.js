...
const PskFilesChooser = class {
    ...
    mapFileToDiv(file) {
        return h("div", { class: "fileDiv" }, h("button", { type: "button", class: "btn btn-secondary trashButton", onClick: () => this.deleteFileFromList(file) }, h("span", null, "X")), h("p", null, file.name));
    }
    render() {
